            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('penjualan*') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penjualan/retur') ? 'active' : ''}}" href="{{route('penjualan.retur')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penjualan/retur/trans') ? 'active' : ''}}" href="{{route('penjualan.retur.trans')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penjualan/returrusak') ? 'active' : ''}}" href="{{route('penjualan.returrusak')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penjualan/returrusak/trans') ? 'active' : ''}}" href="{{route('penjualan.returrusak.trans')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
