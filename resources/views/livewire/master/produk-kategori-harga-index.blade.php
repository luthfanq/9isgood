<div>
    <x-molecules.card title="Data Produk Kategori Harga">
        <x-slot name="toolbar">
            <x-atoms.button.btn-modal target="#modal_form">New Data</x-atoms.button.btn-modal>
        </x-slot>
        <livewire:datatables.produk-kategori-harga-table />
    </x-molecules.card>

    <x-molecules.modal title="Form Produk Kategori Harga" id="modal_form" size="lg" wire:ignore.self>
        <form>
