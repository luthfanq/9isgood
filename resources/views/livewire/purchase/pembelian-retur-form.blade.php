<div>
    <x-molecules.card title="Form Pembelian">
        <div class="row">
            <div class="col-8">
                <form>
                    <div class="row mb-6">
                        <div class="col-6">
                            <x-atoms.input.group-horizontal label="Supplier" name="supplier_id" required="required">
                                <x-atoms.input.text name="supplier_id" wire:model.defer="supplierNama" readonly="" data-bs-toggle="modal" data-bs-target="#supplier_modal"/>
