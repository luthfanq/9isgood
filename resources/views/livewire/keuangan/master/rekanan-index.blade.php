<div>
    <x-molecules.card title="Daftar Rekanan">
        <x-slot name="toolbar">
            <x-atoms.button.btn-modal target="#modal_form">New Data</x-atoms.button.btn-modal>
        </x-slot>
        <livewire:datatables.keuangan.rekanan-table />
    </x-molecules.card>

    <x-molecules.modal title="Form Rekanan" id="modal_form" size="lg" wire:ignore.self>
        <form>
