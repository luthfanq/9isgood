<div>
    <x-molecules.card title="Daftar Kategori Akun">
        <x-slot name="toolbar">
            <x-atoms.button.btn-modal target="#modal_form">New Data</x-atoms.button.btn-modal>
        </x-slot>
        <livewire:datatables.keuangan.akun-kategori-table />
    </x-molecules.card>

    <x-molecules.modal title="Form Kategori Tipe" id="modal_form" size="lg" wire:ignore.self>
        <form>
